		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#desantosemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"desantosemployees-display": {
								"semanticObject": "desantosemployees",
								"action": "display",
								"description": "Employees report with Northwind and ZService",
								"title": "Employees Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.santos.employees",
									"url": sap.ui.require.toUrl("de/santos/employees")
								}
							}
						}
					}
